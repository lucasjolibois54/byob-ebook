...
const MoreAboutUs = () => {
  ...
  const sections = [
    {
      id: 1,
      title: "Low/Mid/High Fade",
      info: " Master every fade level, from subtle to bold, for total style control.",
      src: "/images/2.webp",
      alt: "Company history",
    },
    {
      id: 2,
      title: "Taper Fade",
      info: "Blend hair seamlessly for a clean, natural look that works for any style.",
      src: "/images/3.webp",
      alt: "Our commitment",
    },
    {
      id: 3,
      title: "Fade Beard",
      info: "Shape and fade your beard to match your haircut for a sharp, polished finish.",
      src: "/images/2.webp",
      alt: "Innovation",
    },
    {
        id: 4,
        title: "Facial Razor on Eyebrows",
        info: "Sharpen and define your brows for a clean, professional touch.",
        src: "/images/3.webp",
        alt: "Innovation",
      },
  ];
